...
export default function WinScoreCards(props:any){
    ...
    <ScrollView style={styles.colcards} >
          ...
          <View style={styles.cards}  >
              ...
              <Card><Text style={styles.scorewin}>{props.data.scores1.set1}</Text></Card>
              <Card><Text style={styles.scorewin}>{props.data.scores1.set2}</Text></Card>
              <Card><Text style={styles.scorewin}>{props.data.scores1.set3}</Text></Card>
              <Card><Text style={styles.scorewin}>{props.data.scores1.set4}</Text></Card>
              <Card><Text style={styles.scorewin}>{props.data.scores1.set5}</Text></Card>
          </View>
          <View style={styles.cards} >
            <Score>
              ...
              <Score><Text style={styles.score}>{props.data.scores2.set1}</Text></Score>
              <Score><Text style={styles.score}>{props.data.scores2.set2}</Text></Score>
              <Score><Text style={styles.score}>{props.data.scores2.set3}</Text></Score>
              <Score><Text style={styles.score}>{props.data.scores2.set4}</Text></Score>
              <Score><Text style={styles.score}>{props.data.scores2.set5}</Text></Score>
          </View> 
      </ScrollView>
    )
}
