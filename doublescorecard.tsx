        ...
        <ScrollView style={styles.colcards}>
            ...
            <Image source={{uri:props.data.image12}} style={styles.doublesimages}/>
              ...
              <Card>
                    <View style={styles.tieview}>
                        <Text style={styles.doubleswin}>{props.data.scores1.set1}</Text>
              ...
              <Card>
                    <View style={styles.tieview}>
                        <Text style={styles.doubleswin}>{props.data.scores1.set2}</Text>
              ...
              <Card>
                    <View style={styles.tieview}>
                        <Text style={styles.doubleswin}>{props.data.scores1.set3}</Text>
              ...
              <Card>
                    <View style={styles.tieview}>
                        <Text style={styles.doubleswin}>{props.data.scores1.set4}</Text>
              ...
              <Card>
                    <View style={styles.tieview}>
                        <Text style={styles.doubleswin}>{props.data.scores1.set5}</Text>
          ...
          <Score>
            ...
            <Image source={{uri:props.data.image22}} style={styles.doublesimages}/>
              ...
              <Score>
                    <View style={styles.tieview}>
                        <Text style={styles.doublebase}>{props.data.scores2.set1}</Text>
              ...
              <Score>
                    <View style={styles.tieview}>
                        <Text style={styles.doublebase}>{props.data.scores2.set2}</Text>
              ...
              <Score>
                    <View style={styles.tieview}>
                        <Text style={styles.doublebase}>{props.data.scores2.set3}</Text>
              ...
              <Score>
                    <View style={styles.tieview}>
                        <Text style={styles.doublebase}>{props.data.scores2.set4}</Text>
              ...
              <Score>
                    <View style={styles.tieview}>
                        <Text style={styles.doublebase}>{props.data.scores2.set5}</Text>
